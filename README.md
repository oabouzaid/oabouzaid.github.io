...
A particle-theme template as a landing page for my portfolio.
...
# Using the Template
  ...
  - Upload your resume in the place of `resume.pdf` (Or One can use the famous deedy template and build on that)
